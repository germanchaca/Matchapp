 ...
 */
public abstract class PostMatchRequest {
    ...
    public PostMatchRequest(String userId){
        this.userId = userId;
    }
    public void make() {

        BaseStringRequest signUpRequest = new BaseStringRequest(RestAPIContract.POST_MATCH, getHeaders(), getBody() ,getResponseListener(), getErrorListener(), Request.Method.POST);
                ...
                try{
                    if (error.networkResponse!= null){
                        ...
                        if  (error instanceof NoConnectionError) {
                            ...
                            onPostMatchRequestFailedDefaultError();
                        }
                    }else {
