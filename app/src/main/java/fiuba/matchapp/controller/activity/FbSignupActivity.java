...
public class FbSignupActivity extends GetLocationActivity {
    ...
    private void initViews() {
        ...
        progressDialog = new LockedProgressDialog(FbSignupActivity.this,
    ...
    public void initSignUpFromFacebookData(Intent extras) {
        fbId = FacebookUtils.getFbId(extras);

        profileImage = FacebookUtils.getProfilePhotoUri(extras);
        ...
        if(!TextUtils.equals(userFromFacebookData.getGenre(),"")){
    ...
    public void signup() {
        ...
        String userPassword = MD5.getHashedPassword(fbId);
    ...
    private void launchFinishingSignUpActivity( ArrayList<Interest> interests) {
        ...
        intent.putExtra("fbProfileUrl", profileImage);
